...
цепочки `OR`, скобки или перечень из десятков сущностей.** Укажи релевантные
календарные даты естественным языком, например `August 10 2026 August 11 2026`,
и добавь только несколько самых сильных тематических терминов этого прохода.
