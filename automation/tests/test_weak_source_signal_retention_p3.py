...
P3B_MATRIX = ROOT / "automation" / "specs" / "p3b-exact-authoritative-binding-matrix.md"
...
class WeakSourceSignalRetentionP3Tests(unittest.TestCase):
    ...
    def test_canonical_docs_keep_p3a_evidence_only_and_activate_bounded_p3b(self) -> None:
        architecture = ARCHITECTURE.read_text(encoding="utf-8")
        matrix = SEARCH_MATRIX.read_text(encoding="utf-8")
        p3b_matrix = P3B_MATRIX.read_text(encoding="utf-8")
        ...
        self.assertIn("P3b exact authoritative binding", architecture)
        self.assertIn("`request_started`", architecture)
