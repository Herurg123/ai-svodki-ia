...
> временные доказательства rejection передаются в существующий resolution;
> использованный supplemental slot не открывается повторно через execute entrypoint.
